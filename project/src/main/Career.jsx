...
let slider; // Store slider reference for arrow navigation
  ...
  return (
      ...
      <div className="w-full px-6 md:px-16 py-20 bg-gradient-to-r from-gray-200 via-gray-100 to-gray-200 shadow-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-14">
          {jobListings.map((job, index) => (
            <div
              key={index}
              className="bg-white p-8 rounded-lg shadow-xl hover:shadow-2xl transition-all border border-gray-300 hover:border-blue-500 transform hover:scale-105"
            >
              ...
              <h4 className="text-lg font-semibold text-gray-900">Role Overview:</h4>
              <p className="text-sm text-gray-700 mb-2">{job.roleOverview}</p>

              <h4 className="text-lg font-semibold text-gray-900">Preferred Qualifications:</h4>
              ...
              <Link to={`/apply/${job.id}`}>
                <button className="mt-4 w-full bg-black hover:bg-gray-800 transition text-white px-6 py-3 rounded-lg font-semibold shadow-md hover:shadow-lg">
                  Apply Now
                </button>
              </Link>
            </div>
    ...
    <div className="w-full px-6 md:px-16 py-20 bg-white text-black text-center">
      ...
      <div className="relative max-w-6xl mx-auto">
        {/* Left Arrow */}
        <button
          className="absolute left-0 top-1/2 transform -translate-y-1/2 z-10 bg-gray-800 text-white p-3 rounded-full shadow-lg hover:bg-gray-900 transition-all"
        ...
        {/* Right Arrow */}
        <button
          className="absolute right-0 top-1/2 transform -translate-y-1/2 z-10 bg-gray-800 text-white p-3 rounded-full shadow-lg hover:bg-gray-900 transition-all"
        ...
        <Slider
          {...sliderSettings}
          ref={(sliderRef) => (slider = sliderRef)} // Store slider reference for arrow navigation
      ...
      <div className="w-full px-6 md:px-16 py-20 bg-gray-50 text-black">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          {/* Innovation Block */}
          <div className="bg-white p-10 rounded-lg shadow-lg hover:shadow-2xl transition-all border border-gray-200 hover:border-blue-500">
            <h3 className="text-3xl font-bold text-black mb-6">Innovation</h3>
            <p className="text-gray-700 text-lg">
              We believe in pushing boundaries and creating solutions that redefine what’s possible. Innovation is at the heart of everything we do. By embracing emerging technologies and fostering a culture of creativity, we continuously challenge the status quo. Our goal is to develop transformative solutions that make a lasting impact on industries and communities.
            </p>
          </div>

          {/* Collaboration Block */}
          <div className="bg-white p-10 rounded-lg shadow-lg hover:shadow-2xl transition-all border border-gray-200 hover:border-blue-500">
            <h3 className="text-3xl font-bold text-black mb-6">Collaboration</h3>
            <p className="text-gray-700 text-lg">
            Our strength lies in our diverse team. We work together to solve complex challenges and deliver exceptional results. Through open communication, mutual respect, and collective problem-solving, we harness the power of teamwork. By bringing together different perspectives and expertise, we drive meaningful innovation and long-term success.
            </p>
          </div>

          {/* Sustainability Block */}
          <div className="bg-white p-10 rounded-lg shadow-lg hover:shadow-2xl transition-all border border-gray-200 hover:border-blue-500">
            <h3 className="text-3xl font-bold text-black mb-6">Sustainability</h3>
            <p className="text-gray-700 text-lg">
            We are committed to building a better future by integrating sustainable practices into our projects and operations. From reducing our carbon footprint to implementing eco-friendly solutions, we prioritize sustainability at every level. Our approach ensures that we create responsible and lasting technological advancements for future generations.
            </p>
          </div>

          {/* Integrity Block */}
          <div className="bg-white p-10 rounded-lg shadow-lg hover:shadow-2xl transition-all border border-gray-200 hover:border-blue-500">
            <h3 className="text-3xl font-bold text-black mb-6">Integrity</h3>
            <p className="text-gray-700 text-lg">
            We uphold the highest standards of ethics and transparency in all our interactions, ensuring trust and reliability. Honesty, accountability, and fairness are the core pillars of our work culture. By maintaining integrity in everything we do, we build strong relationships with our employees, clients, and partners, fostering long-term trust and credibility.
            </p>
          </div>
        </div>
      </div>
     ...
     <div className="w-full px-6 md:px-16 py-16 bg-white text-gray-900 relative">
        <p className="text-left  text-lg max-w-4xl mx-auto">
